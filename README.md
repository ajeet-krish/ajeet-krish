...
| [Cauchy: 2D Finite Element Structural Solver](https://ajeet-krish.github.io/Cauchy-FEA/) | C++20, FEA, OpenMP, Three.js | Header-only C++20 finite element solver featuring bar and Q4 elements, COO-to-CSR sparse assembly, Cholesky/CG solvers, GCI h-refinement, and an interactive Three.js WebGL viewer. |
